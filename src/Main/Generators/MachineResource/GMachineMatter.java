...
public class GMachineMatter extends AGMachineResource<MachineMatter> {
    ...
    protected void readLine(BufferedReader br, String[] s) throws IOException {
        ...
        MachineMatter m = new MachineMatter(s[0],
                new LPlasma(false, "pos_"+s[0]+"_matter", "Positive "+localName+" Matter", s[2], 1000, 15, 15000, 10000, false),
                new LPlasma(false, "neg_"+s[0]+"_matter", "Negative "+localName+" Matter", s[2], 1000, 15, 15000, 10000, false)
        );
        objects.add(m);
    }
}
