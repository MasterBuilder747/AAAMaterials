...
public abstract class AGMLiquid <L extends AMLiquid> extends AGMaterialData<L> {
    ...
    public AGMLiquid(int params, GMachine machine, GRegistry registry, GLiquidRegistry liquids, GPartGroup partGroup, String filename, GMaterial material, boolean isReg) {
        ...
        super(params, filename, machine, material, partGroup, "Liquid", registry, liquids, isReg);
    }
