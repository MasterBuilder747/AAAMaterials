...
public class GMPlasma extends AGMLiquid<MPlasma> {
    public GMPlasma(String filename, GRegistry registry, GLiquidRegistry liquids, GMachine machine, GMaterial material, GPartGroup partGroup, boolean isReg) {
    ...
    protected void readMaterialParameters(Material m, String[] s) {
        ...
        objects.add(new MPlasma(m, getMachineRegistry(),
