...
public abstract class AGLocal<L extends ALocalizedData> extends AGRecipeObject<L> {
    ...
    public AGLocal(int params, String filename, GMachine machine) {
        super(params+2, "custom-"+filename, "Custom", machine);
    }
    public AGLocal(int params, String filename, String localFolder, GMachine machine) {
        super(params+2, "custom-"+filename, "Custom/"+localFolder, machine);
    }
