...
public abstract class AGLiquid<L extends ALiquid> extends AGLocal<L> {
    public AGLiquid(int params, String filename, boolean isReg, GRegistry registry, GLiquidRegistry liquids, GMachine machine) {
        super(params, filename, "Liquid", isReg, registry, liquids, machine);
    }
}
