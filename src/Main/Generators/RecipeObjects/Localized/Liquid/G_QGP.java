...
public class G_QGP extends AGLiquid<LQGP> {
    public G_QGP(String filename, GMachine machine, GRegistry registry, GLiquidRegistry liquids, GOreDictRegistry ores, GMachineData data, GMachineMatter matter, boolean isReg) {
    ...
    protected void addParameters(String name, String localName, String[] s) {
        ...
        objects.add(new LQGP(false, getMachineRegistry(), getDataRegistry(), getMatterRegistry(), getRegistries(),
