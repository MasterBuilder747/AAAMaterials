...
public class GLiquid extends AGLiquid<LLiquid> {
    public GLiquid(String filename, GMachine machine, GRegistry registry, GLiquidRegistry liquids, GOreDictRegistry ores, GMachineData data, GMachineMatter matter, boolean isReg) {
    ...
    protected void addParameters(String name, String localName, String[] s) {
        ...
        objects.add(new LLiquid(false, getMachineRegistry(), getDataRegistry(), getMatterRegistry(), getRegistries(),
