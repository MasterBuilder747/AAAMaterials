...
public class GMolten extends AGLiquid<LMolten> {
    public GMolten(String filename, GMachine machine, GRegistry registry, GLiquidRegistry liquids, GOreDictRegistry ores, GMachineData data, GMachineMatter matter, boolean isReg) {
